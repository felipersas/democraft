...
description: Register your own visual components by creating a custom Remotion entry point.
---

import { Callout } from "fumadocs-ui/components/callout";
import { Steps, Step } from "fumadocs-ui/components/steps";

By default, Democraft renders with a built-in entry point that knows about the four built-in renderers (`motion.*` + `remocn.*`). To use **your own components** — whether cloned from the remocn registry or written from scratch — you create a **custom entry point** that registers them.
