---
title: Steps
description: The fourteen step kinds that compose a scene.
---

import { Callout } from "fumadocs-ui/components/callout";
import { TypeTable } from "fumadocs-ui/components/type-table";

A **step** is the atomic unit of a scene. Democraft has fourteen step kinds, grouped into five families: browser actions, assertions, camera moves, timeline control, and overlays.
